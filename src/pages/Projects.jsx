    ...
    <>
      <section id="projects" className={darkMode ? "dark" : ""}>
        ...
        <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-10">
          <div className="flex px-10 py-10 my-20 gap-14">
            <div className="transform duration-300 translate-x-10 hover:scale-105 shadow-lg max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              ...
              <div className="p-5">
                ...
                <a
                  href="https://github.com/zinlinxtet/FOS"
                  target="__blank"
            ...
            <div className="transform duration-300 translate-x-10 hover:scale-105 shadow-lg max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              ...
              <div className="p-5">
                ...
                <a
                  href="https://github.com/zinlinxtet/employee-reg-laravel7-v2"
                  target="__blank"
                  className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-cyan-700 rounded-lg hover:bg-cyan-800 focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:bg-cyan-600 dark:hover:bg-cyan-700 dark:focus:ring-cyan-800"
                >
                  <BsGithub className="me-3" />
