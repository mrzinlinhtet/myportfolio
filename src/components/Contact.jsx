...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_pqaxh4i', 'template_mb1totj', form.current, 'eQPIKWGNgXy0ZNakn')
      .then((result) => {
  ...
  return (
    <div id="contact" className="w-full min-h-screen">
      ...
      <form ref={form} onSubmit={sendEmail} className="flex flex-col justify-center items-center mt-5 ">
